...
\1 Some interesting facts:
	...
	\2 Women often need over 15 minutes to become aroused enough to be able to orgasm.
...
\1 Overall, $<$30\% of women orgasm each session. With $\geq$21 minutes of foreplay, it jumps to $>$90\%.
...
\begin{outline}
\1 Yay, a diagram!
\1 \emph{Vulva}: the external genitals of a woman (lips and even Venus mound) altogether.
\end{outline}
...
\begin{outline}
\1 Between the urethra and the vagina is urethral sponge that is there to cushion the urethra against damage during sex.
...
\1 And here we discover that the claim about "18 parts of the clitoris" is bullshit made up by feminist pagans, including pelvic floor muscles, the sponge beneath the taint, the labia minora... LMAO.
\end{outline}
...
\begin{outline}
\1 During foreplay:
	\2 Blood rushes to the pelvic region, so tissues swell and fluid pushes through the vaginal walls.
...
\1 After orgasm, males and females both can't tolerate more stimulation, but differ in the timeframe:
...
\1 Calls a societal standard that prefers oral sex reserved to committed relationships "boring".
...
\1 Fractions of various groups of women in 1994 who had oral sex in the last year: of women who viewed sex as recreational, 84\%; of women who viewed it as confined to a loving relationship, 74\%; of women who didn't believe in premarital sex, 56\%. But... the study didn't control for marital status... so this is a failed jab at the sexual satisfaction of married traditional women.
...
\1 Hand ties: if she has trouble surrendering, suggest tying her hands.
...
\1 Penetration: there are two ways to use an erection for foreplay.
	...
	\2 Put in "just the tip" (in and out, or just stationary) while gently massaging the clitoral head.
\end{outline}
...
\1 Superset 2: 6 sets of
	\2 5, then 6, then 7, then 8 ... half licks from bottom to mid-vagina that explicitly avoid the clitoral head. The goal to keep in mind is that the head comes out from under the hood.
...
\1 Extra advice:
	\2 Keep this stage slow. It's a marathon, not a sprint. \emph{Don't meet passion with passion}. Control.
...
\begin{enumerate}
	...
	\item While licking, insert the first two knuckles of your index finger into her vagina. Ensure you:
	\begin{itemize}
...
\1 Right hand: index finger inserted into the vagina so that when you straighten-bend-straighten-bend it ("come hither"), you're indenting the G-spot sponge. The base of your finger presses upwards.
